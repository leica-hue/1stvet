...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _loadVerificationStatus() async {
    ...
    try {
      ...
      if (verificationDoc.exists) {
        ...
        // No verification document exists - reset status to empty
        if (mounted) {
          setState(() {
            _verificationStatus = '';
        ...
        print('VERIFICATION STATUS: No verification document found');
      }
    } catch (e) {
  ...
  Future<void> _checkVerificationBeforePremium() async {
    ...
    if (!verificationDoc.exists || _verificationStatus.isEmpty) {
      // No ID submitted yet
      if (mounted) {
        showDialog(
          context: context,
          builder: (context) => AlertDialog(
            ...
            content: const Text(
              'You need to submit your ID for verification before applying for premium. Please upload your ID in the ID Verification section above.',
            ),
            actions: [
              TextButton(
    ...
    if (_verificationStatus == 'pending') {
      // ID submitted and pending review
      if (mounted) {
        showDialog(
          context: context,
          builder: (context) => AlertDialog(
